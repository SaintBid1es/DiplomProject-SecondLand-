package com.example.avitowfxbarrett.API

import com.example.avitowfxbarrett.data.Address
import com.example.avitowfxbarrett.data.Attachment
import com.example.avitowfxbarrett.data.Category
import com.example.avitowfxbarrett.data.Chat
import com.example.avitowfxbarrett.data.Favorite
import com.example.avitowfxbarrett.data.Message
import com.example.avitowfxbarrett.data.Notification
import com.example.avitowfxbarrett.data.PriceHistory
import com.example.avitowfxbarrett.data.Product
import com.example.avitowfxbarrett.data.Promotion
import com.example.avitowfxbarrett.data.Report
import com.example.avitowfxbarrett.data.Review
import com.example.avitowfxbarrett.data.Role
import com.example.avitowfxbarrett.data.Statistic
import com.example.avitowfxbarrett.data.Type
import com.example.avitowfxbarrett.data.User
